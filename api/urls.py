...
from api.views import ImageListView, RegisterView, LoginAPIView, ImageDetailsView, RoleDetailsView, RoleListView
...
urlpatterns = [
    ...
    path('images/', ImageListView.as_view(), name='image-details'),
